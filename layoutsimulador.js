...
// funcion para aumentar el numero del carrito
function cartCounter() {
    let add = document.getElementsByClassName("add-to-cart-btn");
    let reduce = document.getElementsByClassName("remove-btn");
    let cartCounter = document.getElementsByClassName("cart-counter");
    let counter = 0;
